        ...
        <div style={{ backgroundColor: '#d5dbdb', minHeight: '100vh' }}>
            ...
            <div className='flex items-center justify-center max-w-7xl mx-auto'>
                <form
                    ...
                    className='w-full max-w-lg p-4 border border-gray-200 rounded-md my-10 shadow-md bg-white'>
                    ...
                    <div className='flex flex-col items-start justify-start my-5'>
                        ...
                        <div className='flex items-center gap-2 mt-4'>
                            <Label className="mr-2">Upload Profile Picture:</Label>
                            <Input
                                accept="image/*"
                                type="file"
